...
class Status < ApplicationRecord
  ...
  def update_statistics
    return unless distributable? || local_visibility?
  ...
  def increment_counter_caches
    ...
    thread&.increment_count!(:replies_count) if in_reply_to_id.present? && distributable? || local_visibility?
  end
  ...
  def decrement_counter_caches
    ...
    thread&.decrement_count!(:replies_count) if in_reply_to_id.present? && distributable? || local_visibility?
  end
